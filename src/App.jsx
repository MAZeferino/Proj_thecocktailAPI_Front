        ...
        <div className="mx-4 flex items-center justify-between">
          ...
          <div className="flex place-items-center space-x-6">
            <div className="hidden md:flex space-x-4 gap-2">
              <a href="#" className="text-gray-300 text-xl hover:text-white transition-colors"><span className='inline-flex place-items-center gap-0.5'><BiSolidDrink/> Random</span></a>
